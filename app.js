...
request({
  ...
  if(error){
    console.log('Unable to connect to google server.'); // when you messed up with the google address
  }else if (body.status === 'ZERO_RESULTS') {
    console.log('Unable to find that address. ');  // sample when put the wrong zipcode
